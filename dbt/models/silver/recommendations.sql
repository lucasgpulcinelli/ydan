...
SELECT
  ...
  VIDEO_FROM.CHANNEL_ID AS RECOMMENDATION_ORIGIN_CHANNEL_ID,
  VIDEO_TO.CHANNEL_ID AS RECOMMENDATION_DESTINATION_CHANNEL_ID,

  VIDEO_FROM.VIDEO_UPLOAD_DATE AS RECOMMENDATION_ORIGIN_VIDEO_UPLOAD_DATE,
  VIDEO_TO.VIDEO_UPLOAD_DATE AS RECOMMENDATION_DESTINATION_VIDEO_UPLOAD_DATE,
